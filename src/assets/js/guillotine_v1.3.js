 ...
 *
 * Copyright 2014, MatĆ­as Gagliano.
...
(function() {
    ...
    Guillotine = (function() {
        ...
        Guillotine.prototype._move = function(diff) {
            var dx, dy, left, p, top;
            dx = -diff.x || 0;
            dy = -diff.y || 0;
            left = dx === 0 ? null : this.left - dx / this.gllt.clientWidth;
            top = dy === 0 ? null : this.top - dy / this.gllt.clientHeight;
            return this.p = this._offset(left, top)
        };
        ...
        Guillotine.prototype.move = function(diff) {
            return this.enabled && (this._move(diff), this._trigger('rotateLeft'));
        };
    ...
    whitelist = ['rotateLeft', 'rotateRight', 'center', 'fit', 'zoomIn', 'zoomOut', 'instance', 'getData', 'enable', 'disable', 'remove', 'move'];
    ...
    $.fn[pluginName] = function(options, args) {
        if (typeof options !== 'string') {
            ...
            if (options === 'getData') {
                return $.data(this[0], pluginName + 'Instance')[options](args);
            }
            return this.each(function() {
                var guillotine;
                guillotine = $.data(this, pluginName + 'Instance');
                if (guillotine) {
                    return guillotine[options](args);
                }
            });
        }
    };
